...
import SelectedPhotosSection from "./SelectedPhotosSection";
    ...
    <div className="max-w-5xl mx-auto px-6 py-10">
      ...
      <div className="flex items-start justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          <Link
            href={`/events/${client.slug}/edit`}
            className="inline-flex items-center gap-2 border border-white/20 text-neutral-300 text-xs tracking-[0.15em] uppercase px-4 py-2.5 hover:bg-white/5 transition-all"
          >
            Editar
          </Link>
          <a
